...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="h-screen bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <img id="background" class="absolute h-full w-full object-cover"
            src="https://app.clttoolbox.com.au/images/login-bg.jpg" alt="Laravel background" />
                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <div class="grid grid-cols-2 items-center gap-4 py-10 lg:grid-cols-3">
                        <div class="flex lg:justify-center lg:col-start-2">
                            <img src="https://app.clttoolbox.com.au/images/logos/logo_color_white.png" alt=""
